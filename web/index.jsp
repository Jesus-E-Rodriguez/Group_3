...
<div class="showcase--medium-screen-plus background display-flex align-items-center" id="background1">
        <div class="wrapper--unpadded">
            ...
            <p class="text--emphasize">Get ready Charlotte, North Carolina! The world renowned jazz band, Jazz Grasp with members Jesus Rodriguez,
				Katie Kelbaugh, Lauren Jacksina, and Sam Malanchuk, is coming to Theatre Charlotte on April 13, 2018 at 7:30pm for a one time limited 
